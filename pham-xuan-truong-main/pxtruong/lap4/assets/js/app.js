// --- BÀI 1: Khởi tạo AOS ---
 AOS.init({
    ...
    opacity: 1,
    duration: 1.5,
    ease: "power2.out", // Hiệu ứng mượt mà delay: 0.5 // Đợi 0.5s mới chạy
    // Di chuyển sang phải 200px // Hiện rõ dần
    // Trong 1.5 giây
    }); });
    // --- BÀI 4: GSAP Timeline ---
    ...
    const section5 = document.querySelector('#bai5'); const cards = document.querySelectorAll('.card');
    // Lấy vị trí của section so với màn hình
    const sectionPos = section5.getBoundingClientRect().top; const screenPos = window.innerHeight / 1.3;
